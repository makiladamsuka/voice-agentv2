    ...
    <AnimatePresence>
      {active && (
        <motion.div
          ...
          // p-[2px] defines the thickness of the glow border.
          className="absolute inset-0 z-50 rounded-[32px] pointer-events-none p-[2px] overflow-hidden"
          style={{
        ...
        >
          ...
          */}
          <div 
            className="absolute top-1/2 left-1/2 -translate-x-1/2 -translate-y-1/2 w-[250%] h-[250%] blur-[2px] opacity-100 animate-[spin_4s_linear_infinite]"
            style={{
